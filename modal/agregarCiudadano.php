...
<!-- Modal -->
<form id="formAgregarCiudadano" name="formAgregaCiudadano">
<div class="modal fade" id="agregarCiudadano" tabindex="-1" role="dialog" aria-labelledby="agregarCiudadano" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="agregarCiudadano">Actualizar Datos de Ciudadano</h5>
